...
import { updateProfileState, userState } from '../store/atoms';
...
const UpdateProfile = () => {
  ...
  const { updateProfile, clearAllUpdateProfileErrors } = useUpdateProfileActions();
  ...
  }, [loading, error, isUpdated, user, clearAllUpdateProfileErrors, getUser]);
